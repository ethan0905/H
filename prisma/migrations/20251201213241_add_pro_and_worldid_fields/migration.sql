...
INSERT INTO "new_users" ("avatar", "bio", "city", "contributionScore", "country", "createdAt", "currentRank", "displayName", "engagementScore", "id", "invitedById", "invitesCount", "isVerified", "language", "lastActiveAt", "nullifierHash", "profilePictureUrl", "rankScore", "streakDays", "successfulInvitesCount", "totalEarnings", "updatedAt", "username", "verificationLevel", "walletAddress", "worldcoinId") SELECT "avatar", "bio", "city", "contributionScore", "country", "createdAt", "currentRank", "displayName", "engagementScore", "id", "invitedById", "invitesCount", "isVerified", "language", "lastActiveAt", "nullifierHash", "profilePictureUrl", "rankScore", "streakDays", "successfulInvitesCount", "totalEarnings", "updatedAt", "username", "verificationLevel", "walletAddress", "worldcoinId" FROM "users";
DROP TABLE "users";
