  ...
  if (!user) {
    return (
      <div className="card text-center py-8">
        <p className="text-gray-500 mb-4">Sign in to post tweets</p>
      </div>
    );
  }
      ...
      <div className="flex space-x-3">
        ...
        <div className="flex-1">
          <textarea
            ...
            className="w-full min-h-[100px] p-3 border border-gray-200 rounded-lg resize-none focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none text-lg"
            disabled={isLoading}
          />
