        ...
        {isEditing ? (
          ...
          <>
            <div className="mb-4">
              ...
              <p className="text-muted-foreground">Verified Human ✓</p>
            </div>
            <p className="text-foreground mb-4">{bio}</p>
            <div className="flex gap-6 text-sm">
              <div>
                <p className="font-bold text-foreground">{profile.followers?.length || 0}</p>
                <p className="text-muted-foreground">Followers</p>
              </div>
              <div>
                <p className="font-bold text-foreground">{profile.following?.length || 0}</p>
